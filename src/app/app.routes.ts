...
export const routes: Routes = [
  ...
  { path: 'login', loadComponent: () => import('./auth/login/login').then((m) => m.Login) },
  {
    ...
    loadComponent: () => import('./cv/cv-page/cv-page').then((file) => file.CvPage),
  },
  {
    path: 'cv/add',
    loadComponent: () => import('./cv/add-cv/add-cv').then((m) => m.AddCv),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./cv/details-cv/details-cv.component').then((m) => m.DetailsCvComponent),
    resolve: {
  ...
  },
  {
    path: 'word',
    loadComponent: () =>
      import('./directives/mini-word/mini-word.component').then((m) => m.MiniWordComponent),
  },
  {
    path: 'bonjour/:name',
    loadComponent: () => import('./component/second/second').then((m) => m.Second),
  },
